...
THEMES = {
    ...
    # ---- Accessible themes for elderly / low-vision players ----
    'easylight': {
        'name':           'Easy Read Light',
        'font_url':       '',
        ...
        'btn_text':       '#ffffff',
        'btn_blue_bg':    '#ffffff',
        'btn_blue_text':  '#003399',
        'score_first_bg': '#003399',
        'score_first_text': '#ffffff',
        'code_border':    '#003399',
        'font_size_boost': '1.35',
    },
    'easydark': {
        'name':           'Easy Read Dark',
        'font_url':       '',
        ...
        'btn_text':       '#000000',
        'btn_blue_bg':    '#111122',
        'btn_blue_text':  '#ffe600',
        'score_first_bg': '#ffe600',
        'score_first_text': '#000000',
        'code_border':    '#ffe600',
        'font_size_boost': '1.35',
    },
    'highcontrast': {
        ...
        'btn_text':       '#000000',
        'btn_blue_bg':    '#000000',
        'btn_blue_text':  '#ffff00',
        'score_first_bg': '#ffff00',
        'score_first_text': '#000000',
        'code_border':    '#ffffff',
        'font_size_boost': '1.4',
    },
